 ...
 * @example
 * // O provedor é utilizado no NextAuth para permitir o login com credenciais personalizadas:
 * console.log(credentialsProvider); // Provedor de autenticação com credenciais configurado
 */
