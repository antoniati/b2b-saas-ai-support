...
import { TokenService, PasswordService, UserService } from '@/features/users';
import { signIn, signOut } from '@/features/users/auth/auth';
...
export const AuthService = {
  ...
  async requestPasswordReset(email: string): Promise<void> {
    const existingToken = await TokenService.requireByEmail(email, 'RESET_PASSWORD');
