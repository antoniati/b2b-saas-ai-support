export const ERROR_MESSAGES = {
  ...
  INVALID_FIELDS:
    "Existem campos inválidos. Verifique os dados e tente novamente.",
  ...
  // Campos e validações usuário
  INVALID_CREDENTIALS:
    "Credenciais inválidas. Por favor, verifique email e senha.",
  ...
  EMAIL_VERIFICATION_UPDATE_FAILED:
    "Falha ao atualizar a data de verificação do email.",
  EMAIL_NOT_VERIFIED:
  ...
  WEAK_PASSWORD:
    "Senha fraca. Combine letras, números e símbolos (ex.: Abc123!)",
  ...
  NOT_FOUND_2FA:
    "Não foi possível encontrar o código de verificação de dois fatores fornecido.",
  ...
  // Tenants não encontrados
  TENANT_NOT_FOUND: "Tenant não encontrado.",
  TENANT_NOT_FOUND_IN_CONTEXT:
    "Tenant não encontrado no contexto da requisição.",
  TENANT_ACCESS_DENIED:
    "Acesso negado. Este tenant não corresponde ao contexto atual.",
  TENANT_ID_NOT_FOUND_IN_CONTEXT:
    "ID do tenant não encontrado no contexto da requisição.",

  // Validações de tenant
  TENANT_NAME_REQUIRED: "O nome do tenant é obrigatório.",
